...
```{r ans16}
print(sukiyaMenu)
sukiyaMenu[[1]]$category<-NULL
sukiyaMenu[[2]]$category<-NULL
sukiyaMenu4<-list(
  list(category="新登場",
       list(
         sukiyaMenu[[1]]
...
```{r data2}
sukiyaMenu <- jsonlite::fromJSON(", simplifyDataFrame = F)https://www.dropbox.com/s/iu9b1hnvbtss83q/sukiyaMenu.json?dl=1"
```
